...
package com.example.cep_intelligentagroguider
...
import com.example.cep_intelligentagroguider.ui.theme.CEP_IntelligentAgroGuiderTheme
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            CEP_IntelligentAgroGuiderTheme {
                Surface(
    ...
    AndroidView(
        ...
        factory = { context ->
            ...
            WebView(context).apply {
                ...
                loadUrl("file:///android_asset/test_android_app.html")
            }
        },
        update = { webView ->
